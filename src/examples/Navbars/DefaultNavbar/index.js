    ...
    <Container sx={sticky ? { position: "sticky", top: 0, zIndex: 10 } : null}>
      ...
      >
        <MKBox display="flex" justifyContent="space-between" alignItems="center">
          ...
          >
            <MKTypography variant="button" fontWeight="bold" color={light ? "white" : "dark"} display="flex" alignItems="center" >
              <a href="/">
                <img
                  src={logoCT}
                  alt="Logo"
                  style={{ marginRight: '8px', height: '30px', width: '30px', cursor: 'pointer', display:"flex", alignItems:"center"}}
                />
              </a>
              {brand}
            </MKTypography>
