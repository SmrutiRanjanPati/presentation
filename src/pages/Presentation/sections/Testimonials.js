      ...
      <Container>
        ...
        <Grid container spacing={3} justifyContent="center">
          ...
          <Grid item xs={6} md={4} lg={2}>
            <MKBox
              component="img" src={coinbase} alt="coinbase" width="100%"
          ...
          <Grid item xs={6} md={4} lg={2}>
            <MKBox component="img" src={spotify} alt="spotify" width="100%"
              style={{ opacity: 0.4, transition: 'opacity 0.3s' }}
              onMouseOver={(e) => { e.target.style.opacity = '0.9'; }}
              onMouseOut={(e) => { e.target.style.opacity = '0.4'; }} />
          </Grid>
          <Grid item xs={6} md={4} lg={2}>
            <MKBox component="img" src={vodafone} alt="vodafone" width="100%"
              style={{ opacity: 0.4, transition: 'opacity 0.3s' }}
              onMouseOver={(e) => { e.target.style.opacity = '0.9'; }}
              onMouseOut={(e) => { e.target.style.opacity = '0.4'; }} />
          </Grid>
          <Grid item xs={6} md={4} lg={2}>
            <MKBox component="img" src={appleLogo} alt="Apple" width="100%"
              style={{ opacity: 0.4, transition: 'opacity 0.3s' }}
              onMouseOver={(e) => { e.target.style.opacity = '0.9'; }}
              onMouseOut={(e) => { e.target.style.opacity = '0.4'; }} />
          </Grid>
          <Grid item xs={6} md={4} lg={2}>
            <MKBox component="img" src={facebookLogo} alt="Facebook" width="100%"
              style={{ opacity: 0.4, transition: 'opacity 0.3s' }}
              onMouseOver={(e) => { e.target.style.opacity = '0.9'; }}
              onMouseOut={(e) => { e.target.style.opacity = '0.4'; }} />
          </Grid>
          ...
          <Grid item xs={6} md={4} lg={2}>
            <MKBox
              component="img" src={digitalOceanLogo} alt="DigitalOcean" width="100%"
              style={{ opacity: 0.4, transition: 'opacity 0.3s' }}
              onMouseOver={(e) => { e.target.style.opacity = '0.9'; }}
              onMouseOut={(e) => { e.target.style.opacity = '0.4'; }} />
          </Grid>
